...
function fillIncidents( incidents ) {
    for (var i = incidents.length - 1; i >= 0; i--) {
        ...
        $( "#text" ).append( "<p><small>Quelle: " + incidents[i].source.replace("Quelle: ","") + "</small></p><hr>" ); // quick fix to remove duplications
    }
}
        ...
        $.ajax({
            ...
            success: function(cities) {
                ...
                map.addSymbols({
                    ...
                    title: function(city){
                        if (city.location == 'Leipzig')
                            return city.location;
                         if (city.location == 'Dresden')
                            return city.location;
                        if (city.location == 'Chemnitz')
                            return 'Chemnitz';                                   
                        else return null;
                    },
